...
def create_all():
    barbarian = Class(name='Barbarian', details="""
...
""")
    ...
    cleric = Class(name='Cleric', details="""
...
""")
    ...
    druid = Class(name='Druid', details="""
...
""")
    ...
    fighter = Class(name='Fighter', details="""
...
""")
    ...
    paladin = Class(name='Paladin', details="""
...
""")
    ...
    ranger = Class(name='Ranger', details="""
...
""")
    ...
    rogue = Class(name='Rogue', details="""
...
""")
    ...
    sorcerer = Class(name='Sorcerer', details="""
...
""")
    ...
    warlock = Class(name='Warlock', details="""
...
""")
    ...
    wizard = Class(name='Wizard', details="""
...
""")
    ...
    session.merge(barbarian)
    session.merge(bard)
    session.merge(cleric)
    session.merge(druid)
    session.merge(fighter)
    session.merge(monk)
    session.merge(paladin)
    session.merge(ranger)
    session.merge(rogue)
    session.merge(sorcerer)
    session.merge(warlock)
